...
var modify_int_component : ModifyIntEnterKinematicStateComponent
var doubled_state : ComponentState
var doubled_body : KinematicBody2P5D

func before_each():
	modify_int_component = ModifyIntEnterKinematicStateComponent.new()
	...
	modify_int_component.body = doubled_body
