...
var greater_than_component : GreaterThanTransitionKinematicStateComponent
var doubled_state : ComponentState
var doubled_body : KinematicBody2P5D

func before_each():
	greater_than_component = GreaterThanTransitionKinematicStateComponent.new()
	...
	greater_than_component.body = doubled_body
