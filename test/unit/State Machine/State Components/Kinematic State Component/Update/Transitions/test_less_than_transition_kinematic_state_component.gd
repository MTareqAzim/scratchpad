...
var less_than_component : LessThanTransitionKinematicStateComponent
var doubled_state : ComponentState
var doubled_body : KinematicBody2P5D

func before_each():
	less_than_component = LessThanTransitionKinematicStateComponent.new()
	...
	less_than_component.body = doubled_body
